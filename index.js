...
const debaters_uppercase = debaters.map(debaters => debaters.toUpperCase());
...
"Last year I worked on a food application like deliveroo. It was such a great project because we had to create this C# application from scratch, using Mysql. Also it enabled me to discover and to learn alone WPF."
"The final render was beautiful"
...
"thanks to this course, I've learned that there could be many Architectures behind a same looking web application. It could be for instance be a client side or a server side application"
"Also, there are plenty ways to stylish the visual of your website."